...
public class CoalAxe extends AxeItem {
    ...
    public CoalAxe(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public void onUsingTick(ItemStack stack, LivingEntity player, int count) {
        if (player.isOnFire()) {
            stack.shrink(1);
            player.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ModItems.FIRE_AXE.get()));
        }
    }
}
