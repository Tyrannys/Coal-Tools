...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_PICKAXE.get(), 1)
                .pattern("YZY")
                .pattern(" X ")
                .pattern(" X ")
                .define('X', Items.STICK)
                .define('Y', Items.BLAZE_ROD)
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_pickaxe"));
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_SWORD.get(), 1)
                .pattern("Z")
                .pattern("Y")
                .pattern("X")
                .define('X', Items.STICK)
                ...
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_sword"));
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_AXE.get(), 1)
                .pattern("YZ ")
                .pattern("ZX ")
                .pattern(" X ")
                .define('X', Items.STICK)
                ...
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_axe"));
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_AXE.get(), 1)
                .pattern("ZY")
                .pattern("XZ")
                .pattern("X ")
                ...
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_axe2"));
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_SHOVEL.get(), 1)
                .pattern("Y")
                .pattern("Z")
                .pattern("X")
                .define('X', Items.STICK)
                .define('Y', ModItems.FROZEN_FIRE.get())
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_shovel"));
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_HOE.get(), 1)
                .pattern("YZ")
                .pattern(" X")
                .pattern(" X")
                .define('X', Items.STICK)
                ...
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_hoe"));
        ShapedRecipeBuilder.shaped(ModItems.BLAZE_HOE.get(), 1)
                .pattern("ZY")
                .pattern("X ")
                .pattern("X ")
                ...
                .define('Z', ModItems.FROZEN_FIRE.get())
                .unlockedBy("has_item", has(Items.COAL))
                .save(consumer, new ResourceLocation(CoalTools.MODID, "blaze_hoe2"));
